...
namespace FDK
{
	public unsafe class XaDecoder : SoundDecoder	//, IDisposable
	{
		...
		public extern static IntPtr xaDecodeOpen( ref XAHEADER pxah, out FDK.Win32Manager.WAVEFORMATEX pwfx );
		...
		public Win32Manager.WAVEFORMATEX waveformatex;
		...
		public override int Open( string filename )
		{
			...
			waveformatex = new Win32Manager.WAVEFORMATEX();
		...
		public override int GetFormat( int nHandle, ref Win32Manager.WAVEFORMATEX wfx )
		{
