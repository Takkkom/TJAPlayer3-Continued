...
namespace FDK
{
	...
	/// </summary>
	public class CTextureAf : FDKTexture, IDisposable
	{
		...
		public CTextureAf( Device device, string path, Format format, bool transparentBlack )
		...
		/// <exception cref="CTextureCreateFailedException">テクスチャの作成に失敗しました。</exception>
		public CTextureAf( Device device, string path, Format format, bool transparentBlack, Pool pool )
		{
