...
namespace FDK
{
	...
	public class IniFileManager
	{
		...
		public void Read( string path )
		{
			...
			try
			{
				sr = new StreamReader( this.FilePath, Encoding.GetEncoding( "Shift_JIS" ) );	// ファイルが存在しない場合は例外発生。
		...
		public void Write()
		{
			...
			try
			{
				sw = new StreamWriter( this.FilePath, false, Encoding.GetEncoding( "Shift_JIS" ) );	// オープン失敗の場合は例外発生。
