            ...
            if (TJAPlayer3.Tx.Effects_Rainbow != null)
            {
                for (int i = 0; i < 2; i++)
                {
                    if (!this.Rainbow1P[i].IsUsing && player == 0)
                    {
                        ...
                        this.Rainbow1P[i].Counter = new Counter(0, 164, TJAPlayer3.Skin.SkinValue.Game_Effect_Rainbow_Timer, TJAPlayer3.Timer); // カウンタ
                    ...
                    if (!this.Rainbow2P[i].IsUsing && player == 1)
                    {
                        ...
                        this.Rainbow2P[i].Counter = new Counter(0, 164, TJAPlayer3.Skin.SkinValue.Game_Effect_Rainbow_Timer, TJAPlayer3.Timer); // カウンタ
