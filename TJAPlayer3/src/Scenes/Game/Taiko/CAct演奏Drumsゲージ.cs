...
//		}
        ...
        public override void Start(int nLane, E判定 judge, int player)
        {
            for (int j = 0; j < 32; j++)
            {
                if( player == 0 )
                {
                    ...
                    {
                        this.st花火状態[j].ct進行 = new Counter(0, 10, 20, TJAPlayer3.Timer);
                ...
                if( player == 1 )
                {
                    ...
                    {
                        this.st花火状態2P[ j ].ct進行 = new Counter(0, 10, 20, TJAPlayer3.Timer);
		...
		{
            this.ct炎 = new Counter( 0, 6, 50, TJAPlayer3.Timer );

            for (int i = 0; i < 32; i++ )
            {
                this.st花火状態[i].ct進行 = new Counter();
                this.st花火状態2P[i].ct進行 = new Counter();
            }
			base.Activate();
		}
		...
		public override int Draw()
		{
			if ( !base.NotActivated )
			{
                ...
                */
                ...
                {
                    TJAPlayer3.Tx.Gauge_Base[0].Draw2D( TJAPlayer3.app.Device, 492, 144, new Rectangle( 0, 0, 700, 44 ) );
                }
                if( TJAPlayer3.stage演奏ドラム画面.bDoublePlay && TJAPlayer3.Tx.Gauge_Base[1] != null )
                {
                    TJAPlayer3.Tx.Gauge_Base[1].Draw2D( TJAPlayer3.app.Device, 492, 532, new Rectangle( 0, 0, 700, 44 ) );
                }
                #region[ ゲージ1P ]
                if( TJAPlayer3.Tx.Gauge[0] != null )
                {
                    TJAPlayer3.Tx.Gauge[0].Draw2D( TJAPlayer3.app.Device, 492, 144, new Rectangle( 0, 0, nRectX, 44 ) );
			    ...
			    this.ct虹透明度.TickLoop();
                            if(TJAPlayer3.Tx.Gauge_Rainbow[ this.ct虹アニメ.NowValue ] != null )
                            {
				TJAPlayer3.Tx.Gauge_Rainbow[this.ct虹アニメ.NowValue].Opacity = 255;
				TJAPlayer3.Tx.Gauge_Rainbow[this.ct虹アニメ.NowValue].Draw2D(TJAPlayer3.app.Device, 492, 144);
                                TJAPlayer3.Tx.Gauge_Rainbow[虹ベース].Opacity = (ct虹透明度.NowValue * 255 / ct虹透明度.EndValue)/1;
                                TJAPlayer3.Tx.Gauge_Rainbow[虹ベース].Draw2D(TJAPlayer3.app.Device, 492, 144);
                            }
                        }
                        TJAPlayer3.Tx.Gauge_Line[0].Draw2D( TJAPlayer3.app.Device, 492, 144 );
                    }
                    #region[ 「クリア」文字 ]
                    if( this.db現在のゲージ値[ 0 ] >= 80.0 )
                    {
                        TJAPlayer3.Tx.Gauge[0].Draw2D( TJAPlayer3.app.Device, 1038, 144, new Rectangle( 0, 44, 58, 24 ) );
                    }
                    else
                    {
                        TJAPlayer3.Tx.Gauge[0].Draw2D( TJAPlayer3.app.Device, 1038, 144, new Rectangle( 58, 44, 58, 24 ) );
                    }
                    #endregion
                }
                #endregion
                ...
                {
                    TJAPlayer3.Tx.Gauge[1].Draw2D( TJAPlayer3.app.Device, 492, 532, new Rectangle( 0, 0, nRectX2P, 44 ) );
			    ...
			    this.ct虹透明度.TickLoop();
                            if (TJAPlayer3.Tx.Gauge_Rainbow[this.ct虹アニメ.NowValue] != null)
                            {
                                TJAPlayer3.Tx.Gauge_Rainbow[ct虹アニメ.NowValue].Opacity = 255;
                                TJAPlayer3.Tx.Gauge_Rainbow[ct虹アニメ.NowValue].VerticalFlipDraw2D(TJAPlayer3.app.Device, 492, 532);
                                TJAPlayer3.Tx.Gauge_Rainbow[虹ベース].Opacity = (ct虹透明度.NowValue * 255 / ct虹透明度.EndValue) / 1;
                                TJAPlayer3.Tx.Gauge_Rainbow[虹ベース].VerticalFlipDraw2D(TJAPlayer3.app.Device, 492, 532);
                            }
                        }
                        TJAPlayer3.Tx.Gauge_Line[1].Draw2D( TJAPlayer3.app.Device, 492, 532 );
                    }
                    #region[ 「クリア」文字 ]
                    if( this.db現在のゲージ値[ 1 ] >= 80.0 )
                    {
                        TJAPlayer3.Tx.Gauge[1].Draw2D( TJAPlayer3.app.Device, 1038, 554, new Rectangle( 0, 44, 58, 24 ) );
                    }
                    else
                    {
                        TJAPlayer3.Tx.Gauge[1].Draw2D( TJAPlayer3.app.Device, 1038, 554, new Rectangle( 58, 44, 58, 24 ) );
                    }
                    #endregion
                }
                #endregion
                ...
                if(TJAPlayer3.Tx.Gauge_Soul_Fire != null )
                {
                    ...
                    for( int i = 0; i < TJAPlayer3._MainConfig.nPlayerCount; i++ )
                    {
                        ...
                        {
                            this.ct炎.TickLoop();
                            TJAPlayer3.Tx.Gauge_Soul_Fire.Draw2D( TJAPlayer3.app.Device, 1112, nSoulFire[ i ], new Rectangle( 230 * ( this.ct炎.NowValue ), 0, 230, 230 ) );
                        }
                    }
                }
                if(TJAPlayer3.Tx.Gauge_Soul != null )
                {
                    ...
                    for( int i = 0; i < TJAPlayer3._MainConfig.nPlayerCount; i++ )
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Gauge_Soul.Draw2D( TJAPlayer3.app.Device, 1184, nSoulY[ i ], new Rectangle( 0, 0, 80, 80 ) );
                        }
                        else
                        {
                            TJAPlayer3.Tx.Gauge_Soul.Draw2D( TJAPlayer3.app.Device, 1184, nSoulY[ i ], new Rectangle( 0, 80, 80, 80 ) );
                        }
                    }
                }
                ...
                for( int d = 0; d < 32; d++ )
                {
                    ...
                    {
                        this.st花火状態[d].ct進行.Tick();
                        if (this.st花火状態[d].ct進行.IsEndValueReached)
                        {
                            this.st花火状態[d].ct進行.Stop();
                ...
                for( int d = 0; d < 32; d++ )
                {
                    ...
                    {
                        this.st花火状態2P[d].ct進行.Tick();
                        if (this.st花火状態2P[d].ct進行.IsEndValueReached)
                        {
                            this.st花火状態2P[d].ct進行.Stop();
