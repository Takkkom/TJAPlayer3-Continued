...
Trace.TraceInformation( "Command: " + s[ (int) this.Command ] );
		...
		public void tUpdateConfigIni()
		{
			...
			cc.nViewerScrollSpeed     = TJAPlayer3._MainConfig.n譜面スクロール速度;
			cc.bViewerShowDebugStatus = TJAPlayer3._MainConfig.b演奏情報を表示する;
			cc.bViewerVSyncWait       = TJAPlayer3._MainConfig.b垂直帰線待ちを行う;
			cc.bViewerTimeStretch     = TJAPlayer3._MainConfig.bTimeStretch;
