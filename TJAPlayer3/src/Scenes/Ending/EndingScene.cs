...
namespace TJAPlayer3
{
	internal class EndingScene : BaseScene
	{
		...
		public EndingScene()
		{
			base.eステージID = BaseScene.Eステージ.終了;
    ...
    //            CDTXMania.t安全にDisposeする( ref this.ds背景 );
		...
		{
            if( !TJAPlayer3._MainConfig.bEndingAnime ) //2017.01.27 DD
            {
                return 1;
            }
            //if( this.ds背景 != null )
           ...
           //     }
                ...
                if( this.ct時間稼ぎ.IsEndValueReached && !TJAPlayer3.Skin.soundゲーム終了音.b再生中 )
				{
					return 1;
				}
			}
