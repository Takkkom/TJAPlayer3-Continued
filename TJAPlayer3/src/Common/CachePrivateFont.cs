...
namespace TJAPlayer3
{
	...
	/// </summary>
	public class CachePrivateFont : PrivateFont
	{
		/// <summary>
		/// キャッシュ容量
		/// </summary>
		...
		#region [ コンストラクタ ]
		public CachePrivateFont( FontFamily fontfamily, int pt, FontStyle style )
		{
			Initialize( null, fontfamily, pt, style );
		}
		public CachePrivateFont( FontFamily fontfamily, int pt )
		{
			Initialize( null, fontfamily, pt, FontStyle.Regular );
		}
		public CachePrivateFont( string fontpath, int pt, FontStyle style )
		{
			Initialize( fontpath, null, pt, style );
		}
		public CachePrivateFont( string fontpath, int pt )
		{
			Initialize( fontpath, null, pt, FontStyle.Regular );
		}
		public CachePrivateFont()
		{
		...
		{
			this.IsDisposed_CachePrivateFont = false;
        ...
        {
            if (!this.IsDisposed_CachePrivateFont)
            {
                ...
                this.IsDisposed_CachePrivateFont = true;
            }
            base.Dispose();
        }
        //-----------------
        ...
        #region [ private ]
        //-----------------
        protected bool IsDisposed_CachePrivateFont;
		//-----------------
		#endregion
	}
}
