	...
	internal class MainConfig : INotifyPropertyChanged
	{
		...
		public class CKeyAssign
		{
			public class CKeyAssignPad
			{
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] LeftRed
				{
					get
					{
						return this.padLRed;
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] RightRed
				{
					get
					{
						return this.padRRed;
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] LeftBlue
				{
					get
					{
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] RightBlue
				{
					get
					{
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] LeftRed2P
				{
					get
					{
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] RightRed2P
				{
					get
					{
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] LeftBlue2P
				{
					get
					{
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] RightBlue2P
				{
					get
					{
				...
				public MainConfig.CKeyAssign.STKEYASSIGN[] this[ int index ]
				{
					get
					{
						switch ( index )
				...
				private MainConfig.CKeyAssign.STKEYASSIGN[] padRBlue;
				private MainConfig.CKeyAssign.STKEYASSIGN[] padLRed2P;
				private MainConfig.CKeyAssign.STKEYASSIGN[] padLBlue2P;
				private MainConfig.CKeyAssign.STKEYASSIGN[] padRRed2P;
				private MainConfig.CKeyAssign.STKEYASSIGN[] padRBlue2P;

				private MainConfig.CKeyAssign.STKEYASSIGN[] padCapture;
				//-----------------
				#endregion
			}
...
//		public int n切り捨て下限Velocity;			// #23857 2010.12.12 yyagi VelocityMin
		...
		public bool bConfigIniがないかDTXManiaのバージョンが異なる
		{
			get
			{
				return ( !this.ExistConfigFile || !TJAPlayer3.VERSION.Equals( this.strDTXManiaのバージョン ) );
			}
		}
...
//			this.nASIOBufferSizeMs = 0;					// #24820 2012.12.25 yyagi 初期値は0(自動設定)
		...
		public MainConfig( string iniファイル名 )
			: this()
		{
		...
		public void Write( string iniファイル名 )
		{
	...
	//------------------------------
		...
		public void LoadFromFile( string path )
		{
			...
			this.ExistConfigFile = File.Exists( this.ConfigFilePath );
			if( this.ExistConfigFile )
			{
				string str;
				this.tキーアサインを全部クリアする();
				using ( StreamReader reader = new StreamReader( this.ConfigFilePath, Encoding.GetEncoding( "Shift_JIS" ) ) )
				{
								...
								switch( unknown )
								{
									...
									case Eセクション種別.System:
										...
										//----------------------------------------
                                            ...
                                            {
                                                FastRender = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            #endregion
                                            #region [ Window関係 ]
                                            else if (str3.Equals("FullScreen"))
                                            {
                                                this.b全画面モード = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if ( str3.Equals( "WindowX" ) )		// #30675 2013.02.04 ikanick add
											{
												this.n初期ウィンドウ開始位置X = ConvertUtility.GetNumberIfInRange(
											...
											{
												this.n初期ウィンドウ開始位置Y = ConvertUtility.GetNumberIfInRange(
											...
											{
												this.nウインドウwidth = ConvertUtility.GetNumberIfInRange( str4, 1, 65535, this.nウインドウwidth );
											...
											{
												this.nウインドウheight = ConvertUtility.GetNumberIfInRange( str4, 1, 65535, this.nウインドウheight );
											...
											{
												this.bIsAllowedDoubleClickFullscreen = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "EnableSystemMenu" ) )		// #28200 2012.5.1 yyagi
											{
												this.bIsEnabledSystemMenu = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "BackSleep" ) )				// #23568 2010.11.04 ikanick add
											{
												this.n非フォーカス時スリープms = ConvertUtility.RoundToRange( str4, 0, 50, this.n非フォーカス時スリープms );
											}
                                            #endregion
											...
											{
												this.nSoundDeviceType = ConvertUtility.GetNumberIfInRange( str4, 0, 3, this.nSoundDeviceType );
											}
											else if ( str3.Equals( "WASAPIBufferSizeMs" ) )
											{
											    this.nWASAPIBufferSizeMs = ConvertUtility.GetNumberIfInRange( str4, 0, 9999, this.nWASAPIBufferSizeMs );
											}
											else if ( str3.Equals( "ASIODevice" ) )
											{
												string[] asiodev = CEnumerateAllAsioDevices.GetAllASIODevices();
												this.nASIODevice = ConvertUtility.GetNumberIfInRange( str4, 0, asiodev.Length - 1, this.nASIODevice );
											}
											...
											{
												this.bUseOSTimer = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											...
											{
												this.b垂直帰線待ちを行う = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "SleepTimePerFrame" ) )		// #23568 2011.11.27 yyagi
											{
												this.nフレーム毎スリープms = ConvertUtility.RoundToRange( str4, -1, 50, this.nフレーム毎スリープms );
											}
											else if( str3.Equals( "BGAlpha" ) )
											{
												this.n背景の透過度 = ConvertUtility.GetNumberIfInRange( str4, 0, 0xff, this.n背景の透過度 );
											}
											else if( str3.Equals( "DamageLevel" ) )
											{
												this.eダメージレベル = (Eダメージレベル) ConvertUtility.GetNumberIfInRange( str4, 0, 2, (int) this.eダメージレベル );
											}
											else if ( str3.Equals( "StageFailed" ) )
											{
												this.bSTAGEFAILED有効 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											#region [ AVI/BGA ]
											else if( str3.Equals( "AVI" ) )
											{
												this.bAVI有効 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "BGA" ) )
											{
												this.bBGA有効 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "ClipDispType" ) )
											{
												this.eClipDispType = (EClipDispType)ConvertUtility.GetNumberIfInRange( str4, 0, 3, (int) this.eClipDispType );
											}
											#endregion
											#region [ プレビュー音 ]
											else if( str3.Equals( "PreviewSoundWait" ) )
											{
												this.n曲が選択されてからプレビュー音が鳴るまでのウェイトms = ConvertUtility.GetNumberIfInRange( str4, 0, 0x5f5e0ff, this.n曲が選択されてからプレビュー音が鳴るまでのウェイトms );
											}
											else if( str3.Equals( "PreviewImageWait" ) )
											{
												this.n曲が選択されてからプレビュー画像が表示開始されるまでのウェイトms = ConvertUtility.GetNumberIfInRange( str4, 0, 0x5f5e0ff, this.n曲が選択されてからプレビュー画像が表示開始されるまでのウェイトms );
											}
											#endregion
											...
											{
												this.bBGM音を発声する = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											#endregion
											else if( str3.Equals( "SaveScoreIni" ) )
											{
												this.bScoreIniを出力する = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "RandomFromSubBox" ) )
											{
												this.bランダムセレクトで子BOXを検索対象とする = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											#region [ コンボ数 ]
											else if( str3.Equals( "MinComboDrums" ) )
											{
												this.n表示可能な最小コンボ数.Drums = ConvertUtility.GetNumberIfInRange( str4, 1, 0x1869f, this.n表示可能な最小コンボ数.Drums );
											}
											#endregion
											else if( str3.Equals( "ShowDebugStatus" ) )
											{
												this.b演奏情報を表示する = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( nameof(ApplyLoudnessMetadata) ) )
											{
												this.ApplyLoudnessMetadata = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											...
											{
												this.ApplySongVol = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											...
											{
												this.KeyboardSoundLevelIncrement = ConvertUtility.GetNumberIfInRange( str4, MinimumKeyboardSoundLevelIncrement, MaximumKeyboardSoundLevelIncrement, this.KeyboardSoundLevelIncrement );
											}
											...
											{
												this.bストイックモード = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "JudgeDispPriority" ) )
											{
												this.e判定表示優先度 = (E判定表示優先度) ConvertUtility.GetNumberIfInRange( str4, 0, 1, (int) this.e判定表示優先度 );
											}
											else if ( str3.Equals( "AutoResultCapture" ) )			// #25399 2011.6.9 yyagi
											{
												this.bIsAutoResultCapture = ConvertUtility.CharToBool( str4[ 0 ] );
											}
                                            else if (str3.Equals(nameof(SendDiscordPlayingInformation)))
                                            {
                                                SendDiscordPlayingInformation = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if ( str3.Equals( "TimeStretch" ) )				// #23664 2013.2.24 yyagi
											{
												this.bTimeStretch = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											#region [ AdjustTime ]
											else if( str3.Equals( "InputAdjustTime" ) )
											{
												this.nInputAdjustTimeMs = ConvertUtility.GetNumberIfInRange( str4, -99, 99, this.nInputAdjustTimeMs );
											}
											else if ( str3.Equals( "JudgeLinePosOffsetDrums" ) )		// #31602 2013.6.23 yyagi
											{
												this.nJudgeLinePosOffset.Drums = ConvertUtility.GetNumberIfInRange( str4, -99, 99, this.nJudgeLinePosOffset.Drums );
											}
											else if ( str3.Equals( "JudgeLinePosOffsetGuitar" ) )		// #31602 2013.6.23 yyagi
											{
												this.nJudgeLinePosOffset.Guitar = ConvertUtility.GetNumberIfInRange( str4, -99, 99, this.nJudgeLinePosOffset.Guitar );
											}
											else if ( str3.Equals( "JudgeLinePosOffsetBass" ) )			// #31602 2013.6.23 yyagi
											{
												this.nJudgeLinePosOffset.Bass = ConvertUtility.GetNumberIfInRange( str4, -99, 99, this.nJudgeLinePosOffset.Bass );
											}
											else if ( str3.Equals( "JudgeLinePosModeGuitar" ) )	// #33891 2014.6.26 yyagi
											{
												this.e判定位置.Guitar = (E判定位置) ConvertUtility.GetNumberIfInRange( str4, 0, 2, (int) this.e判定位置.Guitar );
											}
											else if ( str3.Equals( "JudgeLinePosModeBass" ) )		// #33891 2014.6.26 yyagi
											{
												this.e判定位置.Bass = (E判定位置) ConvertUtility.GetNumberIfInRange( str4, 0, 2, (int) this.e判定位置.Bass );
											}
											#endregion
											else if( str3.Equals( "BufferedInput" ) )
											{
												this.bバッファ入力を行う = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "PolyphonicSounds" ) )		// #28228 2012.5.1 yyagi
											{
												this.nPoliphonicSounds = ConvertUtility.GetNumberIfInRange( str4, 1, 8, this.nPoliphonicSounds );
											}
											#region [ VelocityMin ]
											else if ( str3.Equals( "LCVelocityMin" ) )			// #23857 2010.12.12 yyagi
											{
												this.nVelocityMin.LC = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.LC );
											}
											else if( str3.Equals( "HHVelocityMin" ) )
											{
												this.nVelocityMin.HH = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.HH );
											}
											else if( str3.Equals( "SDVelocityMin" ) )			// #23857 2011.1.31 yyagi
											{
												this.nVelocityMin.SD = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.SD );
											}
											else if( str3.Equals( "BDVelocityMin" ) )			// #23857 2011.1.31 yyagi
											{
												this.nVelocityMin.BD = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.BD );
											}
											else if( str3.Equals( "HTVelocityMin" ) )			// #23857 2011.1.31 yyagi
											{
												this.nVelocityMin.HT = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.HT );
											}
											else if( str3.Equals( "LTVelocityMin" ) )			// #23857 2011.1.31 yyagi
											{
												this.nVelocityMin.LT = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.LT );
											}
											else if( str3.Equals( "FTVelocityMin" ) )			// #23857 2011.1.31 yyagi
											{
												this.nVelocityMin.FT = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.FT );
											}
											else if( str3.Equals( "CYVelocityMin" ) )			// #23857 2011.1.31 yyagi
											{
												this.nVelocityMin.CY = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.CY );
											}
											else if( str3.Equals( "RDVelocityMin" ) )			// #23857 2011.1.31 yyagi
											{
												this.nVelocityMin.RD = ConvertUtility.GetNumberIfInRange( str4, 0, 127, this.nVelocityMin.RD );
											}
											#endregion
											...
											{
                                                this.bDirectShowMode = ConvertUtility.CharToBool( str4[ 0 ] ); ;
											}
                                            #endregion
                                            else if( str3.Equals( "EndingAnime" ) )
                                            {
                                                this.bEndingAnime = ConvertUtility.CharToBool( str4[ 0 ] );
                                            }
                                    ...
                                    case Eセクション種別.AutoPlay:
                                        ...
                                        {
                                            this.b太鼓パートAutoPlay = ConvertUtility.CharToBool(str4[0]);
                                        }
                                        else if (str3.Equals("Taiko2P"))
                                        {
                                            this.b太鼓パートAutoPlay2P = ConvertUtility.CharToBool(str4[0]);
                                        }
                                        else if (str3.Equals("TaikoAutoRoll"))
                                        {
                                            this.bAuto先生の連打 = ConvertUtility.CharToBool(str4[0]);
                                        }
                                        continue;
                                    //-----------------------------
                                    #endregion
                                    ...
                                    case Eセクション種別.HitRange:
                                        ...
                                        {
                                            this.nヒット範囲ms.Perfect = ConvertUtility.GetNumberIfInRange(str4, 0, 0x3e7, this.nヒット範囲ms.Perfect);
                                        }
                                        else if (str3.Equals("Great"))
                                        {
                                            this.nヒット範囲ms.Great = ConvertUtility.GetNumberIfInRange(str4, 0, 0x3e7, this.nヒット範囲ms.Great);
                                        }
                                        else if (str3.Equals("Good"))
                                        {
                                            this.nヒット範囲ms.Good = ConvertUtility.GetNumberIfInRange(str4, 0, 0x3e7, this.nヒット範囲ms.Good);
                                        }
                                        else if (str3.Equals("Poor"))
                                        {
                                            this.nヒット範囲ms.Poor = ConvertUtility.GetNumberIfInRange(str4, 0, 0x3e7, this.nヒット範囲ms.Poor);
                                        }
                                        continue;
                                    //-----------------------------
                                    #endregion
                                    ...
                                    case Eセクション種別.Log:
										{
											...
											{
												this.bログ出力 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "TraceCreatedDisposed" ) )
											{
												this.bLog作成解放ログ出力 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "TraceDTXDetails" ) )
											{
												this.bLogDTX詳細ログ出力 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "TraceSongSearch" ) )
											{
												this.bLog曲検索ログ出力 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											continue;
										}
									//-----------------------------
									...
									case Eセクション種別.PlayOption:
										{
                                            ...
                                            {
                                                ShowChara = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if( str3.Equals("ShowDancer"))
                                            {
                                                ShowDancer = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if (str3.Equals("ShowRunner"))
                                            {
                                                ShowRunner = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if (str3.Equals("ShowMob"))
                                            {
                                                ShowMob = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if (str3.Equals("ShowFooter"))
                                            {
                                                ShowFooter = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if (str3.Equals("ShowPuchiChara"))
                                            {
                                                ShowPuchiChara = ConvertUtility.CharToBool(str4[0]);
                                            }
                                            else if( str3.Equals( "Dark" ) )
											{
												this.eDark = (Eダークモード) ConvertUtility.GetNumberIfInRange( str4, 0, 2, (int) this.eDark );
											}
                                            else if( str3.Equals( "ScrollMode" ) )
                                            {
                                                this.eScrollMode = ( EScrollMode )ConvertUtility.GetNumberIfInRange( str4, 0, 2, 0 );
                                            }
                                            /*
                                            ...
                                            */
											...
											{
												this.bSudden.Drums = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											#endregion
											#region [ Hidden ]
											else if( str3.Equals( "DrumsHidden" ) )
											{
												this.bHidden.Drums = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											#endregion
											#region [ Invisible ]
											else if ( str3.Equals( "DrumsInvisible" ) )
											{
												this.eInvisible.Drums = (EInvisible) ConvertUtility.GetNumberIfInRange( str4, 0, 2, (int) this.eInvisible.Drums );
											}
											...
											{
												this.bReverse.Drums = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "DrumsPosition" ) )
											{
												this.判定文字表示位置.Drums = (E判定文字表示位置) ConvertUtility.GetNumberIfInRange( str4, 0, 2, (int) this.判定文字表示位置.Drums );
											}
											else if( str3.Equals( "DrumsScrollSpeed" ) )
											{
												this.n譜面スクロール速度.Drums = ConvertUtility.GetNumberIfInRange( str4, 0, 0x7cf, this.n譜面スクロール速度.Drums );
											}
											else if( str3.Equals( "PlaySpeed" ) )
											{
												this.n演奏速度 = ConvertUtility.GetNumberIfInRange( str4, 5, 40, this.n演奏速度 );
											}
											...
											{
												this.nRisky = ConvertUtility.GetNumberIfInRange( str4, 0, 10, this.nRisky );
											}
											else if ( str3.Equals( "DrumsTight" ) )
											{
												this.bTight = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "BranchGuide" ) )
											{
												this.bBranchGuide = ConvertUtility.CharToBool( str4[ 0 ] );
											}
                                            else if ( str3.Equals( "DefaultCourse" ) ) //2017.01.30 DD
                                            {
                                                this.nDefaultCourse = ConvertUtility.GetNumberIfInRange( str4, 0, 4, this.nDefaultCourse );
                                            }
											else if ( str3.Equals( "ScoreMode" ) )
											{
												this.nScoreMode = ConvertUtility.GetNumberIfInRange( str4, 0, 3, this.nScoreMode );
											}
											else if ( str3.Equals( "HispeedRandom" ) )
											{
												this.bHispeedRandom = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "BigNotesWaitTime" ) )
											{
												this.n両手判定の待ち時間 = ConvertUtility.GetNumberIfInRange( str4, 1, 100, this.n両手判定の待ち時間 );
											}
											else if ( str3.Equals( "BigNotesJudge" ) )
											{
												this.b大音符判定 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "BranchAnime" ) )
											{
												this.nBranchAnime = ConvertUtility.GetNumberIfInRange( str4, 0, 1, this.nBranchAnime );
											}
											else if ( str3.Equals( "NoInfo" ) )
											{
												this.bNoInfo = ConvertUtility.CharToBool( str4[ 0 ] );
											}
                                            else if ( str3.Equals( "DefaultSongSort" ) )
                                            {
                                                this.nDefaultSongSort = ConvertUtility.GetNumberIfInRange( str4, 0, 2, this.nDefaultSongSort );
                                            }
											else if( str3.Equals( "TaikoRandom" ) )
											{
												this.eRandom.Taiko = (Eランダムモード) ConvertUtility.GetNumberIfInRange( str4, 0, 4, (int) this.eRandom.Taiko );
											}
											else if( str3.Equals( "TaikoStealth" ) )
											{
												this.eSTEALTH = (Eステルスモード) ConvertUtility.GetNumberIfInRange( str4, 0, 3, (int) this.eSTEALTH );
											}
											else if( str3.Equals( "GameMode" ) )
											{
												this.eGameMode = (EGame) ConvertUtility.GetNumberIfInRange( str4, 0, 2, (int) this.eGameMode );
											}
											else if( str3.Equals( "JudgeCountDisplay" ) )
											{
												this.bJudgeCountDisplay = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if( str3.Equals( "Just" ) )
											{
												this.bJust = ConvertUtility.CharToBool( str4[ 0 ] );
											}
                                            else if( str3.Equals( "PlayerCount" ) )
                                            {
                                                this.nPlayerCount = ConvertUtility.GetNumberIfInRange( str4, 1, 2, this.nPlayerCount );
                                            }
                                            else if(str3.Equals(nameof(ShinuchiMode)))
                                            {
                                                ShinuchiMode = ConvertUtility.CharToBool(str4[0]);
                                            }
											continue;
										}
									//-----------------------------
									...
									case Eセクション種別.ViewerOption:
										{
											...
											{
												this.nViewerScrollSpeed.Drums = ConvertUtility.GetNumberIfInRange( str4, 0, 1999, this.nViewerScrollSpeed.Drums );
											}
											else if ( str3.Equals( "ViewerGuitarScrollSpeed" ) )
											{
												this.nViewerScrollSpeed.Guitar = ConvertUtility.GetNumberIfInRange( str4, 0, 1999, this.nViewerScrollSpeed.Guitar );
											}
											else if ( str3.Equals( "ViewerBassScrollSpeed" ) )
											{
												this.nViewerScrollSpeed.Bass = ConvertUtility.GetNumberIfInRange( str4, 0, 1999, this.nViewerScrollSpeed.Bass );
											}
											else if ( str3.Equals( "ViewerVSyncWait" ) )
											{
												this.bViewerVSyncWait = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "ViewerShowDebugStatus" ) )
											{
												this.bViewerShowDebugStatus = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "ViewerTimeStretch" ) )
											{
												this.bViewerTimeStretch = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "ViewerGuitar" ) )
											{
												this.bViewerGuitar有効 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											else if ( str3.Equals( "ViewerDrums" ) )
											{
												this.bViewerDrums有効 = ConvertUtility.CharToBool( str4[ 0 ] );
											}
											continue;
										}
									//-----------------------------
