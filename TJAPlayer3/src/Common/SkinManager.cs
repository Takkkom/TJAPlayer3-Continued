...
namespace TJAPlayer3
{
    ...
    internal class SkinManager : IDisposable
    {
        ...
        public class Cシステムサウンド : IDisposable
        {
            ...
            public static SkinManager.Cシステムサウンド r最後に再生した排他システムサウンド;
            ...
            public int n位置_現在のサウンド
            {
                get
                {
                    FDKSound sound = this.rSound[1 - this.n次に鳴るサウンド番号];
                    if (sound == null)
                        return 0;
            ...
            public int n位置_次に鳴るサウンド
            {
                get
                {
                    FDKSound sound = this.rSound[this.n次に鳴るサウンド番号];
                    if (sound == null)
                        return 0;
            ...
            public Cシステムサウンド(string strファイル名, bool bループ, bool b排他, bool bCompact対象, SoundGroup soundGroup)
            {
            ...
            public void t読み込み()
            {
				...
				if( !File.Exists( SkinManager.Path( this.strファイル名 ) ) )
				{
...
//                    }
                ...
                for (int i = 0; i < 2; i++)     // 一旦Cloneを止めてASIO対応に専念
                {
                    try
                    {
                        this.rSound[i] = TJAPlayer3._SoundManager.CreateFDKSound(SkinManager.Path(this.strファイル名), _soundGroup);
                    }
                    catch
                    {
                        this.rSound[i] = null;
            ...
            {
                if (TJAPlayer3._SoundManager.GetCurrentSoundDeviceType() != "DirectShow")
                {
                    for (int i = 0; i < 2; i++)
                    {
                        if (this.rSound[i] != null)
                        {
                            TJAPlayer3._SoundManager.RemoveMixer(this.rSound[i]);
                        }
                    }
                }
            }
            ...
            private FDKSound[] rSound = new FDKSound[2];
            //-----------------
            #endregion
        }
        ...
        // コンストラクタ
        public SkinManager(string _strSkinSubfolderFullName, bool _bUseBoxDefSkin)
        {
        ...
        {
            strSystemSkinRoot = System.IO.Path.Combine(TJAPlayer3.DirectoryWithThisEXE, "System" + System.IO.Path.DirectorySeparatorChar);
        ...
        public void PrepareReloadSkin()
        {
            ...
            this.soundカーソル移動音 = new Cシステムサウンド(@"Sounds\Move.ogg", false, false, false, SoundGroup.SoundEffect);
            this.sound決定音 = new Cシステムサウンド(@"Sounds\Decide.ogg", false, false, false, SoundGroup.SoundEffect);
            this.sound変更音 = new Cシステムサウンド(@"Sounds\Change.ogg", false, false, false, SoundGroup.SoundEffect);
            this.sound取消音 = new Cシステムサウンド(@"Sounds\Cancel.ogg", false, false, true, SoundGroup.SoundEffect);
            this.sound歓声音 = new Cシステムサウンド(@"Sounds\Audience.ogg", false, false, true, SoundGroup.SoundEffect);
            this.soundSTAGEFAILED音 = new Cシステムサウンド(@"Sounds\Stage failed.ogg", false, true, true, SoundGroup.Voice);
            this.soundゲーム開始音 = new Cシステムサウンド(@"Sounds\Game start.ogg", false, false, false, SoundGroup.Voice);
            this.soundゲーム終了音 = new Cシステムサウンド(@"Sounds\Game end.ogg", false, true, false, SoundGroup.Voice);
            this.soundステージクリア音 = new Cシステムサウンド(@"Sounds\Stage clear.ogg", false, true, true, SoundGroup.Voice);
            this.soundフルコンボ音 = new Cシステムサウンド(@"Sounds\Full combo.ogg", false, false, true, SoundGroup.Voice);
            this.sound曲読込開始音 = new Cシステムサウンド(@"Sounds\Now loading.ogg", false, true, true, SoundGroup.Unknown);
            this.soundタイトル音 = new Cシステムサウンド(@"Sounds\Title.ogg", false, true, false, SoundGroup.SongPlayback);
            this.bgm起動画面 = new Cシステムサウンド(@"Sounds\Setup BGM.ogg", true, true, false, SoundGroup.SongPlayback);
            this.bgmオプション画面 = new Cシステムサウンド(@"Sounds\Option BGM.ogg", true, true, false, SoundGroup.SongPlayback);
            this.bgmコンフィグ画面 = new Cシステムサウンド(@"Sounds\Config BGM.ogg", true, true, false, SoundGroup.SongPlayback);
            this.bgm選曲画面 = new Cシステムサウンド(@"Sounds\Select BGM.ogg", true, true, false, SoundGroup.SongPreview);
            ...
            this.soundBalloon = new Cシステムサウンド(@"Sounds\balloon.ogg", false, false, true, SoundGroup.SoundEffect);
            this.sound曲決定音 = new Cシステムサウンド(@"Sounds\SongDecide.ogg", false, false, true, SoundGroup.Voice);
            this.sound成績発表 = new Cシステムサウンド(@"Sounds\ResultIn.ogg", false, false, false, SoundGroup.Voice);
            ReloadSkin();
            tReadSkinConfig();
        }
                ...
                if ((str.Length != 0) && (str[0] != ';'))
                {
                    try
                    {
                        ...
                        if (strArray.Length == 2)
                        {
                            ...
                            {
                                this.nScrollFieldY[0] = ConvertUtility.StringToInt(strParam, 192);
                            }
                            else if (strCommand == "ScrollFieldP2Y")
                            {
                                this.nScrollFieldY[1] = ConvertUtility.StringToInt(strParam, 192);
                            }
                            else if (strCommand == "SENotesP1Y")
                            {
                                this.nSENotesY[0] = ConvertUtility.StringToInt(strParam, this.nSENotesY[0]);
                            }
                            else if (strCommand == "SENotesP2Y")
                            {
                                this.nSENotesY[1] = ConvertUtility.StringToInt(strParam, this.nSENotesY[1]);
                            }
                            else if (strCommand == "JudgePointP1Y")
                            {
                                this.nJudgePointY[0] = ConvertUtility.StringToInt(strParam, this.nJudgePointY[0]);
                            }
                            else if (strCommand == "JudgePointP2Y")
                            {
                                this.nJudgePointY[1] = ConvertUtility.StringToInt(strParam, this.nJudgePointY[1]);
                            }

                            else if (strCommand == "DiffDispMode")
                            {
                                this.eDiffDispMode = (E難易度表示タイプ)ConvertUtility.GetNumberIfInRange(strParam, 0, 2, (int)this.eDiffDispMode);
                            }
                            else if (strCommand == "NowStageDisp")
                            {
                                this.b現在のステージ数を表示しない = ConvertUtility.CharToBool(strParam[0]);
                            }
                            ...
                            {
                                this.nResultPanelP1X = ConvertUtility.StringToInt(strParam, 515);
                            }
                            else if (strCommand == "ResultPanelP1Y")
                            {
                                this.nResultPanelP1Y = ConvertUtility.StringToInt(strParam, 75);
                            }
                            else if (strCommand == "ResultPanelP2X")
                            {
                                this.nResultPanelP2X = ConvertUtility.StringToInt(strParam, 515);
                            }
                            else if (strCommand == "ResultPanelP2Y")
                            {
                                this.nResultPanelP2Y = ConvertUtility.StringToInt(strParam, 75);
                            }
                            else if (strCommand == "ResultScoreP1X")
                            {
                                this.nResultScoreP1X = ConvertUtility.StringToInt(strParam, 582);
                            }
                            else if (strCommand == "ResultScoreP1Y")
                            {
                                this.nResultScoreP1Y = ConvertUtility.StringToInt(strParam, 252);
                            }
                            //-----------------------------
                            #endregion
                            #region[ その他 ]
                            ...
                            {
                                SongLoading_Plate_ScreenBlend = ConvertUtility.CharToBool(strParam[0]);
                            }
                            #endregion
                            #region Game
                            else if (strCommand == "Game_Notes_Anime")
                            {
                                Game_Notes_Anime = ConvertUtility.CharToBool(strParam[0]);
                            }
                            ...
                            {
                                Game_JudgeFrame_AddBlend = ConvertUtility.CharToBool(strParam[0]);
                            }
                            ...
                            {
                                Game_Taiko_Combo_Ex_IsJumping = ConvertUtility.CharToBool(strParam[0]);
                            }
                            #endregion
                            #region Gauge
                            ...
                            {
                                Game_Effect_GoGoSplash_Rotate = ConvertUtility.CharToBool(strParam[0]);
                            }
                            ...
                            {
                                Game_Effect_FlyingNotes_IsUsingEasing = ConvertUtility.CharToBool(strParam[0]);
                            }
                            ...
                            {
                                Game_Effect_HitExplosion_AddBlend = ConvertUtility.CharToBool(strParam[0]);
                            }
                            else if (strCommand == nameof(Game_Effect_HitExplosionBig_AddBlend))
                            {
                                Game_Effect_HitExplosionBig_AddBlend = ConvertUtility.CharToBool(strParam[0]);
                            }
                            else if (strCommand == nameof(Game_Effect_FireWorks_AddBlend))
                            {
                                Game_Effect_FireWorks_AddBlend = ConvertUtility.CharToBool(strParam[0]);
                            }
                            else if (strCommand == nameof(Game_Effect_Fire_AddBlend))
                            {
                                Game_Effect_Fire_AddBlend = ConvertUtility.CharToBool(strParam[0]);
                            }
                            else if (strCommand == nameof(Game_Effect_GoGoSplash_AddBlend))
                            {
                                Game_Effect_GoGoSplash_AddBlend = ConvertUtility.CharToBool(strParam[0]);
                            }
