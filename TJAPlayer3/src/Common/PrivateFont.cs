    ...
    public class PrivateFont : IDisposable
	{
		...
		protected Bitmap DrawPrivateFont_V( string drawstr, Color fontColor, Color edgeColor, bool bVertical )
		{
            ...
            for (int i = 0; i < strName.Length; i++)
            {
                ...
                {
                    edgeOffsetX = TJAPlayer3.Skin.SongSelect_CorrectionX_Chara_Value;
                }
                else
                {
                    edgeOffsetX = 0;
                ...
                {
                    edgeOffsetY = TJAPlayer3.Skin.SongSelect_CorrectionY_Chara_Value;
                }
                else
                {
                    edgeOffsetY = 0;
        ...
        public void Dispose()
        {
            if (!this.IsDiposed)
            {
                ...
                if (this._PrivateFontCollection != null)
                {
