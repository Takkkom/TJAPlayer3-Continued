...
namespace TJAPlayer3
{
	public class ScoreIni
	{
		...
		{
            public ScoreIni.C演奏記録 HiScoreDrums;
            public ScoreIni.C演奏記録 HiSkillDrums;
			public ScoreIni.C演奏記録 HiScoreGuitar;
            public ScoreIni.C演奏記録 HiSkillGuitar;
			public ScoreIni.C演奏記録 HiScoreBass;
            public ScoreIni.C演奏記録 HiSkillBass;
            public ScoreIni.C演奏記録 LastPlayDrums;   // #23595 2011.1.9 ikanick
            public ScoreIni.C演奏記録 LastPlayGuitar;  //
            public ScoreIni.C演奏記録 LastPlayBass;    //
			public ScoreIni.C演奏記録 this[ int index ]
			{
				get
				{
					switch( index )
		...
		/// </summary>
		public ScoreIni( string str読み込むiniファイル )
			: this()
		{
				...
				while( ( str = reader.ReadLine() ) != null )
				{
					...
					if( ( str.Length != 0 ) && ( str[ 0 ] != ';' ) )
					{
						...
						Label_01C7:
							...
							{
								this.stファイル.PlayCountDrums = ConvertUtility.GetNumberIfInRange( para, 0, 99999999, 0 );
							}
							else if( item.Equals( "PlayCountGuitars" ) )// #23596 11.2.5 changed ikanick
							{
								this.stファイル.PlayCountGuitar = ConvertUtility.GetNumberIfInRange( para, 0, 99999999, 0 );
							}
							else if( item.Equals( "PlayCountBass" ) )
							{
								this.stファイル.PlayCountBass = ConvertUtility.GetNumberIfInRange( para, 0, 99999999, 0 );
                            }
                            // #23596 10.11.16 add ikanick------------------------------------/
                            else if (item.Equals("ClearCountDrums"))
                            {
                                this.stファイル.ClearCountDrums = ConvertUtility.GetNumberIfInRange(para, 0, 99999999, 0);
                            }
                            else if (item.Equals("ClearCountGuitars"))// #23596 11.2.5 changed ikanick
                            {
                                this.stファイル.ClearCountGuitar = ConvertUtility.GetNumberIfInRange(para, 0, 99999999, 0);
                            }
                            else if (item.Equals("ClearCountBass"))
                            {
                                this.stファイル.ClearCountBass = ConvertUtility.GetNumberIfInRange(para, 0, 99999999, 0);
                            }
                            // #24459 2011.2.24 yyagi-----------------------------------------/
							else if ( item.Equals( "BestRankDrums" ) )
							{
								this.stファイル.BestRank.Drums = ConvertUtility.GetNumberIfInRange( para, (int) ERANK.SS, (int) ERANK.E, (int) ERANK.UNKNOWN );
							}
							else if ( item.Equals( "BestRankGuitar" ) )
							{
								this.stファイル.BestRank.Guitar = ConvertUtility.GetNumberIfInRange( para, (int) ERANK.SS, (int) ERANK.E, (int) ERANK.UNKNOWN );
							}
							else if ( item.Equals( "BestRankBass" ) )
							{
								this.stファイル.BestRank.Bass = ConvertUtility.GetNumberIfInRange( para, (int) ERANK.SS, (int) ERANK.E, (int) ERANK.UNKNOWN );
							}
							//----------------------------------------------------------------/
							...
							{
								this.stファイル.HistoryCount = ConvertUtility.GetNumberIfInRange( para, 0, 99999999, 0 );
							}
							else if( item.Equals( "BGMAdjust" ) )
							{
								this.stファイル.BGMAdjust = ConvertUtility.StringToInt( para, 0 );
							}
							continue;
							#endregion
						...
						Label_03B9:
							...
							{
								c演奏記録.bTight = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "SuddenDrums" ) )
							{
								c演奏記録.bSudden.Drums = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "SuddenGuitar" ) )
							{
								c演奏記録.bSudden.Guitar = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "SuddenBass" ) )
							{
								c演奏記録.bSudden.Bass = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "HiddenDrums" ) )
							{
								c演奏記録.bHidden.Drums = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "HiddenGuitar" ) )
							{
								c演奏記録.bHidden.Guitar = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "HiddenBass" ) )
							{
								c演奏記録.bHidden.Bass = ConvertUtility.CharToBool( para[ 0 ] );
							}
							...
							{
								c演奏記録.bReverse.Drums = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "ReverseGuitar" ) )
							{
								c演奏記録.bReverse.Guitar = ConvertUtility.CharToBool( para[ 0 ] );
							}
							else if ( item.Equals( "ReverseBass" ) )
							{
								c演奏記録.bReverse.Bass = ConvertUtility.CharToBool( para[ 0 ] );
							}
							#endregion
							else
							{
								...
								{
									c演奏記録.bLight.Guitar = ConvertUtility.CharToBool( para[ 0 ] );
								}
								#endregion
								#region [ LightBass ]
								else if ( item.Equals( "LightBass" ) )
								{
									c演奏記録.bLight.Bass = ConvertUtility.CharToBool( para[ 0 ] );
								}
								#endregion
								#region [ LeftGuitar ]
								else if ( item.Equals( "LeftGuitar" ) )
								{
									c演奏記録.bLeft.Guitar = ConvertUtility.CharToBool( para[ 0 ] );
								}
								#endregion
								#region [ LeftBass ]
								else if ( item.Equals( "LeftBass" ) )
								{
									c演奏記録.bLeft.Bass = ConvertUtility.CharToBool( para[ 0 ] );
								}
								#endregion
								else
								{
									...
									else
									{
										...
										{
											c演奏記録.bGuitar有効 = ConvertUtility.CharToBool( para[ 0 ] );
										}
										#endregion
										#region [ Drums ]
										else if ( item.Equals( "Drums" ) )
										{
											c演奏記録.bDrums有効 = ConvertUtility.CharToBool( para[ 0 ] );
										}
										#endregion
										#region [ StageFailed ]
										else if ( item.Equals( "StageFailed" ) )
										{
											c演奏記録.bSTAGEFAILED有効 = ConvertUtility.CharToBool( para[ 0 ] );
										}
										#endregion
										else
										{
											...
											{
												c演奏記録.b演奏にキーボードを使用した = ConvertUtility.CharToBool( para[ 0 ] );
											}
											else if ( item.Equals( "UseMIDIIN" ) )
											{
												c演奏記録.b演奏にMIDI入力を使用した = ConvertUtility.CharToBool( para[ 0 ] );
											}
											else if ( item.Equals( "UseJoypad" ) )
											{
												c演奏記録.b演奏にジョイパッドを使用した = ConvertUtility.CharToBool( para[ 0 ] );
											}
											else if ( item.Equals( "UseMouse" ) )
											{
												c演奏記録.b演奏にマウスを使用した = ConvertUtility.CharToBool( para[ 0 ] );
											}
											...
											{
												c演奏記録.レーン9モード = ConvertUtility.CharToBool( para[ 0 ] );
											}
        ...
        internal static double t超精密型スキルを計算して返す( Chart dtx, int nTotal, int nPerfect, int nGood, int nMiss, int Poor, int nMaxLagTime, int nMinLagTimen, int nMaxCombo )
        {
            //演奏成績 最大60点
            //最大コンボ 最大5点
            //空打ち 最大10点(減点あり)
		...
		{
            bDrumsを更新する = !TJAPlayer3._MainConfig.b太鼓パートAutoPlay;
			bGuitarを更新する = false;
			bBassを更新する =   false;
		}
