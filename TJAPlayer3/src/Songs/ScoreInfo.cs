...
namespace TJAPlayer3
{
	...
	internal class ScoreInfo
	{
		...
		public struct ST譜面情報
		{
			...
			public struct STRANK
			{
				...
				public int this[ int index ]
				{
					...
					set
					{
						if ( ( value < (int)ScoreIni.ERANK.SS ) || ( ( value != (int)ScoreIni.ERANK.UNKNOWN ) && ( value > (int)ScoreIni.ERANK.E ) ) )
						{
		...
		public ScoreInfo()
		{
			...
			this.譜面情報.最大ランク.Drums =  (int)ScoreIni.ERANK.UNKNOWN;
			this.譜面情報.最大ランク.Guitar = (int)ScoreIni.ERANK.UNKNOWN;
			this.譜面情報.最大ランク.Bass =   (int)ScoreIni.ERANK.UNKNOWN;
			...
			this.譜面情報.曲種別 = Chart.E種別.DTX;
			this.譜面情報.Bpm = 120.0;
			this.譜面情報.Duration = 0;
            this.譜面情報.strBGMファイル名 = "";
            this.譜面情報.SongVol = FDKSound.DefaultSongVol;
