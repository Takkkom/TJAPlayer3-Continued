...
{
	internal class CActFIFOBlack : Activity
	{
		// メソッド
		...
		public override int Draw()
		{
			...
			{
                TJAPlayer3.Tx.Tile_Black.Opacity = ( this.mode == EFIFOモード.フェードイン ) ? ( ( ( 100 - this.counter.NowValue ) * 0xff ) / 100 ) : ( ( this.counter.NowValue * 0xff ) / 100 );
