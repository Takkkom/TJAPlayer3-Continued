...
{
	internal class BlackFade : Activity
	{
		// メソッド
		...
		public override int Draw()
		{
			...
			{
                TJAPlayer3.Tx.Tile_Black.Opacity = ( this.NowFadeState == FadeModeType.FadeIn ) ? ( ( ( 100 - this._Counter.NowValue ) * 0xff ) / 100 ) : ( ( this._Counter.NowValue * 0xff ) / 100 );
