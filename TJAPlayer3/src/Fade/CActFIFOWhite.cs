...
{
	internal class CActFIFOWhite : Activity
	{
		// メソッド
		...
		public override int Draw()
		{
			...
			{
                TJAPlayer3.Tx.Tile_White.Opacity = ( this.mode == EFIFOモード.フェードイン ) ? ( ( ( 100 - this.counter.NowValue ) * 0xff ) / 100 ) : ( ( this.counter.NowValue * 0xff ) / 100 );
